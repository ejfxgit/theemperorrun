...
function key(event){
    ...
    document.getElementById('boy').style.top = '200px';
...
var p=700;
 ...
 function f(){
    for(var y=0; y<10; y++){
        ...
        a.style.marginTop = "470px"; // Match boy's marginTop
        a.style.height = "700px";    // Force height in JS
        a.style.width = "auto";      // Keep aspect ratio
